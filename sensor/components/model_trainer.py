...
class ModelTrainer:
    ...
    def train_model(self, x_train, y_train):
        try:
            # Instantiate the LightGBM Classifier with the given parameters
            lgbm_clf = LGBMClassifier(
                learning_rate=1.7004813265076016e-05,
                num_leaves=222,
                max_depth=4,
                n_estimators=853,
                min_child_samples=15,
                subsample=0.535541684043332,
                colsample_bytree=0.5316662994337524,
                reg_alpha=8.935199194894047e-08,
                reg_lambda=0.061783196831867615
