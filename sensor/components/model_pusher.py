...
import shutil #FOR COPYING PATH FROM SOURCE TO DESTINATION
...
class ModelPusher:
    ...
    def initiate_model_pusher(self,)->ModelPusherArtifact:
        try:
            trained_model_path = self.model_eval_artifact.trained_model_path #wE ARE LOADING THE MODEL FROM MODEL EVALUATION ARTIFACT AND COPYING IT TO model_file_path AND saved_model_path
