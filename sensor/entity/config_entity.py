#This file makes the directory as per the folder structure given for data ingestion
...
class TrainingPipelineConfig:
    ...
    def __init__(self,timestamp=datetime.now()): #On the basis of time this, directories will be made for example data ingestion, data transformation and so on in the artifact folder
...
class DataIngestionConfig:
        ...
        def __init__(self,training_pipeline_config:TrainingPipelineConfig):
            ...
            self.training_file_path: str = os.path.join(
                self.data_ingestion_dir, training_pipeline.DATA_INGESTION_INGESTED_DIR_NAME, training_pipeline.TRAINING_FILE_NAME
            )
